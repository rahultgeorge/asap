...
public:
  ...
  const GCOVFunction *getFunction(const Function *F) const ;
  ...
  public:
    ...
    void addBlockLine(StringRef Filename, uint32_t Line,
  ...
  protected:
    ...
    using FileCoverageList =
        SmallVector<std::pair<std::string, GCOVCoverage>, 4>;
